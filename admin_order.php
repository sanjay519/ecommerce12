...
include "confg.php";
 $q= "select * from delivery order by sno desc";
...
<div class="container">
	...
	<div class="row justify-content-left">
		...
		<div class= "col-lg-6 px4 pb-4 " id="order">
         ...
         <h4 class="tect-center text-info p-2">OUR ORDERS</h4>
 ...
 <!-- inside php ...name,email, phone is the column name of the given table in database-->
  ...
  <tr>
	 ...
	 <td> <?php echo $rows['rupee']  ?> </td>
	   ...
	   <td> <?php echo $rows['usname']  ?> </td>
		 <td> <?php echo $rows['card']  ?> </td>
		  <td> <?php echo $rows['amount']  ?> </td>
          <td> <?php echo $rows['delivered']  ?> </td>
        <td> <?php echo $rows['remark']  ?> </td>

	      <td><a href='up.php?trans=<?php echo $rows['transaction']; ?>'>Update </a></td>
