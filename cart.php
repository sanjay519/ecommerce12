...
<div class="row"class="justify-content-center">
  <div class="col-lg-10">
    <div style="display: <?php if(isset($_SESSION['showAlert'])) {echo $_SESSION['showAlert']; }else{echo 'none';} unset($_SESSION['showAlert']);  ?>" class="alert alert-success alert-dismisssible mt-3">
    ...
    <div class="table">
     ...
     <tbody>
       ...
       <tr>
         ...
         <td><i class="fa fa-inr" ></i>&nbsp;&nbsp;<?= $row['product_price'] ?></td>
      ...
      <?php $_SESSION['grand_total'] += (int)$row['total_price']; ?>
     ...
     <tr>
       <td colspan="2">
         <a href="indexx.php" class="btn btn-success"><i class="fa fa-cart-plus">&nbsp;&nbsp;</i>Continue Shopping</a>
       </td>

       <td colspan="1"><b>Grand Total</b></td>
       <td><b><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;&nbsp;<?= $_SESSION['grand_total'] ?><b></td>
        <td>
          
          <a href="checkout.php" class="btn btn-info <?=($_SESSION['grand_total'] >1)?:"disabled" ?>"  ><i class="fa fa-credit-card"></i>&nbsp;&nbsp;Checkout</a>
        </td>
     </tr>
     </tbody>
