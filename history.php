...
include "confg.php";
 ...
 $q= "select date, transaction,   phone , delivery , product , rupee, amount , mode, delivered, Status , remark from delivery   where name='$abc'  order by date desc ";
...
<div class="container ">
	<div class="row justify-content-left">
		...
		<div class= "col-lg-6 px4 pb-4 " id="order">
			...
			<br>
         <h4 class="tect-center text-info p-2">MY ORDERS</h4>
